...
- **Type:** Archivo (display, 600–900) + Source Sans 3 (body, 400–900), Google Fonts, latin-ext. Headings `font-black`, tracking −0.015em global, **word-spacing 0.12em on h1–h6 + `.font-display`** (session 35 — Archivo's space glyph is very narrow and negative tracking shrinks word gaps too; do NOT remove or caps headlines run together). (Body was Manrope until session 34 — owner found its narrow word space hard to read; Source Sans 3 = humanist, open apertures, wider word space, contrast axis vs grotesque Archivo.)
