    ...
    return (
      <div className="max-w-lg mx-auto text-center py-12">
        ...
        <div className="flex gap-3 justify-center">
          <button onClick={() => navigate('/rentals')} className="bg-royal-500 text-white px-6 py-2.5 rounded-lg font-medium hover:bg-royal-600 transition-colors">
            Moje prenájmy
          </button>
          <button onClick={() => navigate('/catalog')} className="border border-gray-300 px-6 py-2.5 rounded-lg font-medium hover:bg-gray-50 transition-colors">
            Späť do katalógu
          </button>
        </div>
      </div>
  ...
  if (items.length === 0) {
    return (
      <div className="max-w-lg mx-auto text-center py-12">
        ...
        <button onClick={() => navigate('/catalog')} className="bg-royal-500 text-white px-6 py-2.5 rounded-lg font-medium hover:bg-royal-600 transition-colors">
          Prejsť do katalógu
        </button>
      </div>
    );
