...
export default function Profile() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      {/* Royal Card Status */}
      <div className="bg-gradient-to-r from-royal-500 to-royal-600 rounded-xl p-5 text-white mb-6">
      ...
      <button onClick={handleSave} disabled={saving}
        className="flex items-center gap-2 bg-royal-500 hover:bg-royal-600 text-white font-medium px-6 py-2.5 rounded-lg transition-colors disabled:opacity-50">
