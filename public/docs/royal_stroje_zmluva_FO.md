...
| **Zmluva č.:** |  | **Fakturačný e-mail:** |  |

| Názov, typ a popis predmetu prenájmu (PP) | Výrobné číslo | Druh sadzby | Sadzba/deň vrátane DPH (EUR) |
| :---- | :---- | :---- | :---- |
|  |  |  |  |
|  |  |  |  |
|  |  |  |  |
...
| INFORMÁCIE O PRENÁJME |  | FINANČNÉ PODMIENKY |  |
| :---- | :---- | :---- | :---- |
| **Začiatok prenájmu:** |  | **Celkové nájomné vrát. DPH (EUR):** |  |
| **Dohodnutá dĺžka / koniec:** |  | **Záloha (depozit) požadovaná (EUR):** |  |
| **Skutočný koniec prenájmu:** |  | **Záloha (depozit) vrátená (EUR):** |  |
| **Miesto používania PP:** |  | **Spôsob platby nájomného:** |  |
| **Miesto odovzdania PP:** |  | **Spôsob úhrady zálohy:** |  |

| Ostatné informácie o PP a príslušenstve:  | Prevzatie PP – výhrady k stavu (ak žiadne, nechajte prázdne):  |
| :---- | :---- |
...
| PODPISY ZMLUVNÝCH STRÁN   | PROTOKOL O VRÁTENÍ PP |
| :---- | :---- |
|  **Za prenajímateľa:** Meno a priezvisko:   Dátum: Miesto: Podpis:   **Nájomca – spotrebiteľ:** Meno a priezvisko:   Dátum:   Miesto: Podpis:    | **Dátum a čas vrátenia:**   **Stav PP pri vrátení:**   **Poškodenia / chýbajúce príslušenstvo:**   Vyčistený:  ☐ Áno   ☐ Nie     Fotodokumentácia:  ☐ Áno   ☐ Nie **Podpis prenajímateľa:**   **Podpis nájomcu:**   |
