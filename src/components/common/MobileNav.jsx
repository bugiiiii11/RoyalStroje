...
export default function MobileNav() {
  ...
  const navItems = [
    ...
    { path: '/kosik', icon: ShoppingCart, label: 'Košík' },
  ];

  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-black/98 backdrop-blur-md border-t border-white/10 safe-area-inset-bottom">
