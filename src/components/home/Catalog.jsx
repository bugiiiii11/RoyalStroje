  ...
  return (
    <ContentSection id="katalog" light className="pt-0">
      ...
      <img
        ...
        aria-hidden="true"
        className="hidden lg:block absolute top-[20px] left-0 w-auto h-[clamp(190px,19vw,290px)] z-0 pointer-events-none select-none"
        width={1000}
        height={664}
        loading="lazy"
        decoding="async"
      ...
      <img
        ...
        aria-hidden="true"
        className="hidden lg:block absolute top-[40px] right-0 w-auto h-[clamp(160px,16vw,250px)] z-0 pointer-events-none select-none"
        width={1232}
        height={640}
        loading="lazy"
        decoding="async"
