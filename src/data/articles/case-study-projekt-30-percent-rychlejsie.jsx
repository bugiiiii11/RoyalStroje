  ...
  content: (
      <div className="space-y-8">
        ...
        <div className="bg-gradient-to-br from-orange-500/10 to-orange-600/10 border border-orange-primary/30 rounded-2xl p-8">
          <h2 className="text-3xl font-black text-zinc-900 mb-6">📊 O Projekte</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-3">
              <h4 className="text-orange-primary font-bold text-lg">Základné Info:</h4>
              <ul className="space-y-2 text-zinc-700">
                <li>• <strong className="text-zinc-900">Investor:</strong> Ján K. (42 rokov, IT podnikateľ)</li>
                <li>• <strong className="text-zinc-900">Lokalita:</strong> Senec (10 km od Bratislavy)</li>
                <li>• <strong className="text-zinc-900">Typ:</strong> Rodinný dom - murovaná stavba</li>
                <li>• <strong className="text-zinc-900">Rozmer:</strong> 10 × 12 m (1 podlažie + podkrovie)</li>
                <li>• <strong className="text-zinc-900">Pozemok:</strong> 800 m² (mierne svažitý)</li>
              </ul>
            </div>
            <div className="space-y-3">
              <h4 className="text-green-700 font-bold text-lg">Výsledky:</h4>
              <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4 space-y-2">
                <p className="text-zinc-900 text-xl font-bold">✓ Hrubá stavba: o 30% rýchlejšie</p>
                <p className="text-zinc-900 text-xl font-bold">✓ Úspora: 3,325 €</p>
                <p className="text-zinc-900 text-xl font-bold">✓ Kvalita: bez chýb a reklamácií</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* The Challenge */}
        <div>
          <h2 className="text-2xl font-black text-zinc-900 mb-4">🎯 Výzva</h2>
        ...
        <div>
          <h2 className="text-2xl font-black text-zinc-900 mb-4">📋 Pôvodný vs. Realizovaný Plán</h2>
          <div className="grid md:grid-cols-2 gap-6">
            {/* Original Plan */}
            <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-6">
              <h3 className="text-red-600 font-black text-xl mb-4">❌ Pôvodný Plán</h3>
              <div className="space-y-4">
                <div>
                  <h4 className="text-zinc-900 font-bold mb-2">Júl - August:</h4>
                  <p className="text-zinc-600 text-sm">Čakanie na murára (žiadna práca)</p>
                </div>
                <div>
                  <h4 className="text-zinc-900 font-bold mb-2">September:</h4>
                ...
                <div>
                  <h4 className="text-zinc-900 font-bold mb-2">Október - November:</h4>
                  <ul className="text-zinc-600 text-sm space-y-1">
                    <li>• Múrovanie</li>
                    <li>• Strop</li>
                  </ul>
                ...
                <div>
                  <h4 className="text-zinc-900 font-bold mb-2">December:</h4>
                  <p className="text-zinc-600 text-sm">Strecha (riziko snehu/mrazu)</p>
                </div>
                <div className="bg-white/10 rounded-lg p-3 mt-4">
                  <p className="text-zinc-900 font-bold">Celkom: 6 mesiacov</p>
                  <p className="text-red-600 font-bold text-lg">Náklady: 4,500 € (mechanizácia od firmy)</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-6">
              <h3 className="text-green-700 font-black text-xl mb-4">✓ Realizovaný Plán (Royal Stroje)</h3>
              <div className="space-y-4">
                <div>
                  <h4 className="text-zinc-900 font-bold mb-2">Júl:</h4>
                ...
                <div>
                  <h4 className="text-zinc-900 font-bold mb-2">August:</h4>
                  <ul className="text-zinc-700 text-sm space-y-1">
                ...
                <div>
                  <h4 className="text-zinc-900 font-bold mb-2">September:</h4>
                  <p className="text-zinc-700 text-sm">✓ Strecha (ideálne počasie)</p>
                </div>
                <div>
                  <h4 className="text-zinc-900 font-bold mb-2">Október - December:</h4>
                  <p className="text-zinc-700 text-sm">✓ Vnútorné práce (teplo, sucho)</p>
                </div>
                <div className="bg-white/10 rounded-lg p-3 mt-4">
                  <p className="text-zinc-900 font-bold">Celkom: 4 mesiace</p>
                  <p className="text-green-700 font-bold text-lg">Náklady: 1,175 € (prenájom Royal Stroje)</p>
                  <p className="text-green-700 font-bold text-xl mt-2">ÚSPORA: 3,325 €!</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div>
          <h2 className="text-2xl font-black text-zinc-900 mb-4">📅 Timeline: Týždeň po Týždni</h2>
        ...
        {/* Cost Comparison */}
        <div>
          <h2 className="text-2xl font-black text-zinc-900 mb-4">💰 Porovnanie Nákladov</h2>
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b-2 border-orange-primary">
                  <th className="p-3 text-zinc-900 font-bold">Položka</th>
                  <th className="p-3 text-zinc-900 font-bold text-right">Pôvodný plán<br/>(od firmy)</th>
                  <th className="p-3 text-zinc-900 font-bold text-right">Realizované<br/>(Royal Stroje)</th>
                  <th className="p-3 text-zinc-900 font-bold text-right">Úspora</th>
                </tr>
              </thead>
              <tbody className="text-zinc-700">
                <tr className="border-b border-zinc-200">
                  ...
                  <td className="p-3 text-right text-green-700 font-bold">1,100 €</td>
                </tr>
                <tr className="border-b border-zinc-200">
                  <td className="p-3">Vibračná doska</td>
                  <td className="p-3 text-right">350 €</td>
                  <td className="p-3 text-right">150 €</td>
                  <td className="p-3 text-right text-green-700 font-bold">200 €</td>
                </tr>
                <tr className="border-b border-zinc-200">
                  <td className="p-3">Miešačky (betón + malta)</td>
                  <td className="p-3 text-right">600 €</td>
                  <td className="p-3 text-right">265 €</td>
                  <td className="p-3 text-right text-green-700 font-bold">335 €</td>
                </tr>
                <tr className="border-b border-zinc-200">
                  <td className="p-3">Vibrátor betónu</td>
                  <td className="p-3 text-right">180 €</td>
                  <td className="p-3 text-right">60 €</td>
                  <td className="p-3 text-right text-green-700 font-bold">120 €</td>
                </tr>
                <tr className="border-b border-zinc-200">
                  <td className="p-3">Doprava</td>
                  <td className="p-3 text-right">320 €</td>
                  <td className="p-3 text-right">0 €</td>
                  <td className="p-3 text-right text-green-700 font-bold">320 €</td>
                </tr>
                <tr className="border-b border-zinc-200">
                  <td className="p-3">Manažment/Poplatky firmy</td>
                  <td className="p-3 text-right">1,250 €</td>
                  <td className="p-3 text-right">0 €</td>
                  <td className="p-3 text-right text-green-700 font-bold">1,250 €</td>
                </tr>
                <tr className="border-t-2 border-orange-primary bg-orange-500/10">
                  <td className="p-3 font-bold text-zinc-900">CELKOM:</td>
                  <td className="p-3 text-right font-bold text-zinc-900 text-lg">4,500 €</td>
                  <td className="p-3 text-right font-bold text-zinc-900 text-lg">1,175 €</td>
                  <td className="p-3 text-right font-bold text-green-700 text-xl">3,325 €</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div className="bg-gradient-to-br from-zinc-900 to-zinc-950 border border-orange-primary/30 rounded-2xl p-8">
          ...
          <div className="space-y-6">
            <blockquote className="rounded-xl border border-orange-primary/25 bg-orange-primary/[0.08] px-6 py-4 italic text-white/90 text-lg">
        ...
        {/* Key Success Factors */}
        <div>
          <h2 className="text-2xl font-black text-zinc-900 mb-4">🔑 Kľúčové Faktory Úspechu</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-6">
              <h3 className="text-green-700 font-bold text-lg mb-4">✓ Čo Fungovalo:</h3>
              <ul className="space-y-3 text-zinc-700">
                <li className="flex items-start">
                  <span className="text-green-700 mr-2 text-xl">1.</span>
                  <span><strong className="text-zinc-900">Plánovanie vopred:</strong> Ján si rezervoval stroje 3 týždne vopred</span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-700 mr-2 text-xl">2.</span>
                  <span><strong className="text-zinc-900">Dlhší prenájom:</strong> 10 dní namiesto 5 = menej stresu</span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-700 mr-2 text-xl">3.</span>
                  <span><strong className="text-zinc-900">Technická podpora:</strong> Royal Stroje vždy k dispozícii na telefóne</span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-700 mr-2 text-xl">4.</span>
                  <span><strong className="text-zinc-900">Kvalitné stroje:</strong> Žiadna porucha, všetko fungovalo</span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-700 mr-2 text-xl">5.</span>
                  <span><strong className="text-zinc-900">Vlastné tempo:</strong> Práca bez tlaku termínov firmy</span>
                </li>
              </ul>
            </div>
            <div className="bg-orange-500/10 border border-orange-500/30 rounded-xl p-6">
              ...
              <ul className="space-y-3 text-zinc-700">
                <li className="flex items-start">
                  ...
                  <span><strong className="text-zinc-900">Lešenie:</strong> Prenajať si vlastné (nie od murára)</span>
                </li>
                <li className="flex items-start">
                  <span className="text-orange-primary mr-2 text-xl">2.</span>
                  <span><strong className="text-zinc-900">Materiál:</strong> Objednať vopred (2-3 dni doručenie)</span>
                </li>
                <li className="flex items-start">
                  <span className="text-orange-primary mr-2 text-xl">3.</span>
                  <span><strong className="text-zinc-900">Počasie:</strong> Sledovať predpoveď 7 dní vopred</span>
                </li>
                <li className="flex items-start">
                  <span className="text-orange-primary mr-2 text-xl">4.</span>
                  <span><strong className="text-zinc-900">Pomocníci:</strong> Pozvať kamaráta (práca ide rýchlejšie)</span>
                </li>
              </ul>
            </div>
          </div>
