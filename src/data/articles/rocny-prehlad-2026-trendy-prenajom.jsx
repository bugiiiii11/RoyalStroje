  ...
  content: (
      <div className="space-y-8">
        ...
        <div className="bg-gradient-to-br from-orange-500/10 to-orange-600/10 border border-orange-primary/30 rounded-2xl p-8">
          <h2 className="text-3xl font-black text-zinc-900 mb-4">2026: Rok Zmien Na Trhu Prenájmu</h2>
        ...
        {/* Statistics */}
        <div>
          <h2 className="text-2xl font-black text-zinc-900 mb-6">📊 Kľúčové Štatistiky 2026 (Slovensko)</h2>
        ...
        {/* Top 5 Trends */}
        <div>
          <h2 className="text-2xl font-black text-zinc-900 mb-6">🔥 Top 5 Trendov 2026</h2>
        ...
        <div>
          <h2 className="text-2xl font-black text-zinc-900 mb-4">🗺️ Regionálne Rozdiely</h2>
            ...
            <div className="bg-gradient-to-br from-orange-500/10 to-orange-600/10 border border-orange-primary/30 rounded-xl p-6">
              ...
              <div className="space-y-3 text-zinc-700">
                <div className="flex justify-between">
                  ...
                  <span className="text-zinc-900 font-bold">+15-20%</span>
                </div>
                <div className="flex justify-between">
                  <span>Najväčší dopyt:</span>
                  <span className="text-zinc-900 font-bold">Apríl - Júl</span>
                </div>
                <div className="flex justify-between">
                  <span>Najprenajímanejší stroj:</span>
                  <span className="text-zinc-900 font-bold">Minirýpadlo 1,8t</span>
                </div>
                <div className="flex justify-between">
                  <span>DIY zákazníci:</span>
                  <span className="text-zinc-900 font-bold">42%</span>
                </div>
              </div>
            </div>
            <div className="bg-gradient-to-br from-blue-500/10 to-blue-600/10 border border-blue-400/30 rounded-xl p-6">
              <h3 className="text-blue-700 font-black text-xl mb-4">Ostatné Regióny</h3>
              <div className="space-y-3 text-zinc-700">
                <div className="flex justify-between">
                  <span>Priemerná cena prenájmu:</span>
                  <span className="text-zinc-900 font-bold">Štandard</span>
                </div>
                <div className="flex justify-between">
                  <span>Najväčší dopyt:</span>
                  <span className="text-zinc-900 font-bold">Máj - August</span>
                </div>
                <div className="flex justify-between">
                  <span>Najprenajímanejší stroj:</span>
                  <span className="text-zinc-900 font-bold">Vibračná doska</span>
                </div>
                <div className="flex justify-between">
                  <span>DIY zákazníci:</span>
                  <span className="text-zinc-900 font-bold">28%</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div>
          <h2 className="text-2xl font-black text-zinc-900 mb-4">🏆 Top 10 Najprenajímanejších Strojov 2026</h2>
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b-2 border-orange-primary">
                  <th className="p-3 text-zinc-900 font-bold">#</th>
                  <th className="p-3 text-zinc-900 font-bold">Stroj</th>
                  <th className="p-3 text-zinc-900 font-bold text-right">Počet prenájmov</th>
                  <th className="p-3 text-zinc-900 font-bold text-right">Zmena vs. 2024</th>
                  <th className="p-3 text-zinc-900 font-bold text-right">Priem. cena/deň</th>
                </tr>
              </thead>
              <tbody className="text-zinc-700">
                <tr className="border-b border-zinc-200 bg-orange-500/5">
                  <td className="p-3 font-bold text-orange-primary">1</td>
                  <td className="p-3">Minirýpadlo 1,8t</td>
                  <td className="p-3 text-right text-zinc-900 font-bold">12,500</td>
                ...
                <tr className="border-b border-zinc-200">
                  ...
                  <td className="p-3 text-right text-zinc-900 font-bold">9,800</td>
                ...
                <tr className="border-b border-zinc-200">
                  ...
                  <td className="p-3 text-right text-zinc-900 font-bold">7,200</td>
                  <td className="p-3 text-right text-green-700">+9%</td>
                ...
                <tr className="border-b border-zinc-200">
                  ...
                  <td className="p-3 text-right text-zinc-900 font-bold">6,100</td>
                  <td className="p-3 text-right text-red-600">-3%</td>
                ...
                <tr className="border-b border-zinc-200">
                  ...
                  <td className="p-3 text-right text-zinc-900 font-bold">5,800</td>
                  <td className="p-3 text-right text-green-700">+6%</td>
                ...
                <tr className="border-b border-zinc-200">
                  ...
                  <td className="p-3 text-right text-zinc-900 font-bold">4,900</td>
                ...
                <tr className="border-b border-zinc-200">
                  ...
                  <td className="p-3 text-right text-zinc-900 font-bold">3,600</td>
                ...
                <tr className="border-b border-zinc-200">
                  ...
                  <td className="p-3 text-right text-zinc-900 font-bold">2,800</td>
                ...
                <tr className="border-b border-zinc-200">
                  ...
                  <td className="p-3 text-right text-zinc-900 font-bold">2,400</td>
                ...
                <tr className="border-b border-zinc-200">
                  ...
                  <td className="p-3 text-right text-zinc-900 font-bold">2,100</td>
        ...
        {/* Seasonality */}
        <div>
          <h2 className="text-2xl font-black text-zinc-900 mb-4">📅 Sezónnosť Dopytu 2026</h2>
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse text-sm">
              <thead>
                <tr className="border-b border-zinc-200">
                  <th className="p-2 text-zinc-900">Mesiac</th>
                  <th className="p-2 text-zinc-900 text-right">Dopyt</th>
                  <th className="p-2 text-zinc-900">Ceny</th>
                  <th className="p-2 text-zinc-900">Charakteristika</th>
                </tr>
              </thead>
              <tbody className="text-zinc-700">
                <tr className="border-b border-zinc-200">
                  <td className="p-2">Január - Február</td>
                  <td className="p-2 text-right text-red-600 font-bold">20%</td>
                  <td className="p-2"><span className="bg-green-500/20 text-green-700 px-2 py-1 rounded text-xs">Najnižšie (-30%)</span></td>
                  <td className="p-2">Zima, demolácie, vnútorné práce</td>
                </tr>
                <tr className="border-b border-zinc-200">
                  <td className="p-2">Marec</td>
                  <td className="p-2 text-right text-orange-600 font-bold">45%</td>
                  <td className="p-2"><span className="bg-orange-500/20 text-orange-600 px-2 py-1 rounded text-xs">Nízke (-15%)</span></td>
                  <td className="p-2">Rozmrznuti e, príprava na jar</td>
                </tr>
                <tr className="border-b border-zinc-200 bg-orange-500/5">
                  <td className="p-2">Apríl - Júl</td>
                  <td className="p-2 text-right text-green-700 font-bold">100%</td>
                  <td className="p-2"><span className="bg-red-500/20 text-red-600 px-2 py-1 rounded text-xs">Najvyššie (+20%)</span></td>
                  <td className="p-2">PEAK SEZÓNA - plná obsadenosť</td>
                </tr>
                <tr className="border-b border-zinc-200">
                  <td className="p-2">August</td>
                  <td className="p-2 text-right text-orange-600 font-bold">75%</td>
                  <td className="p-2"><span className="bg-yellow-500/20 text-yellow-600 px-2 py-1 rounded text-xs">Štandard</span></td>
                  <td className="p-2">Leto, dovolenky</td>
                </tr>
                <tr className="border-b border-zinc-200">
                  <td className="p-2">September - Október</td>
                  <td className="p-2 text-right text-orange-600 font-bold">65%</td>
                  <td className="p-2"><span className="bg-yellow-500/20 text-yellow-600 px-2 py-1 rounded text-xs">Štandard</span></td>
                  <td className="p-2">Jeseň, terénne úpravy</td>
                </tr>
                <tr className="border-b border-zinc-200">
                  <td className="p-2">November - December</td>
                  <td className="p-2 text-right text-red-600 font-bold">30%</td>
                  <td className="p-2"><span className="bg-green-500/20 text-green-700 px-2 py-1 rounded text-xs">Nízke (-25%)</span></td>
        ...
        {/* Customer Mistakes */}
        <div>
          <h2 className="text-2xl font-black text-zinc-900 mb-4">❌ Top 5 Chýb Zákazníkov V 2026</h2>
          <div className="space-y-4">
            <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-4">
              <h4 className="text-red-600 font-bold mb-2">1. Príliš Krátky Prenájom (38% zákazníkov)</h4>
              <p className="text-zinc-600 text-sm">Rezervácia na 1 deň, ale práca trvá 2 dni = nutnosť predĺženia = vyššia cena + stres.</p>
              <p className="text-green-700 text-sm mt-2"><strong>Riešenie:</strong> Radšej +1 deň rezerva.</p>
            </div>
            <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-4">
              <h4 className="text-red-600 font-bold mb-2">2. Nesprávny Typ Stroja (29% zákazníkov)</h4>
              <p className="text-zinc-600 text-sm">Prenajatie mikro minirýpadla (0,8t) na výkop základov = slabý výkon = strata času.</p>
              <p className="text-green-700 text-sm mt-2"><strong>Riešenie:</strong> Poradiť sa s požičovňou.</p>
            </div>
            <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-4">
              <h4 className="text-red-600 font-bold mb-2">3. Zabudnutie Na Príslušenstvo (24% zákazníkov)</h4>
              <p className="text-zinc-600 text-sm">Minirýpadlo bez lopáty / kompresor bez búracieho kladiva = nemožno pracovať.</p>
              <p className="text-green-700 text-sm mt-2"><strong>Riešenie:</strong> Checklist pred prevzatím.</p>
            </div>
            <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-4">
              <h4 className="text-red-600 font-bold mb-2">4. Neprečítanie Zmluvných Podmienok (19% zákazníkov)</h4>
              <p className="text-zinc-600 text-sm">Kaučia, palivo, poistenie = prekvapenie pri vrátení.</p>
              <p className="text-green-700 text-sm mt-2"><strong>Riešenie:</strong> Prečítať si zmluvu PRED podpisom.</p>
            </div>
            <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-4">
              <h4 className="text-red-600 font-bold mb-2">5. Rezervácia Na Poslednú Chvíľu (17% zákazníkov)</h4>
              <p className="text-zinc-600 text-sm">Rezervácia deň vopred = žiadna dostupnosť v peak sezóne.</p>
              <p className="text-green-700 text-sm mt-2"><strong>Riešenie:</strong> Rezervovať 2-3 týždne vopred.</p>
            </div>
          </div>
        </div>
        ...
        {/* 2026 Predictions */}
        <div>
          <h2 className="text-2xl font-black text-zinc-900 mb-4">🔮 Predpovede Na 2026</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-6">
              <h3 className="text-green-700 font-bold text-lg mb-4">✓ Pozitívne Trendy:</h3>
              <ul className="space-y-2 text-zinc-700 text-sm">
                <li>• <strong className="text-zinc-900">DIY segment:</strong> Ďalší rast +20%</li>
                <li>• <strong className="text-zinc-900">Elektrické stroje:</strong> Dvojnásobný rast</li>
                <li>• <strong className="text-zinc-900">Online rezervácie:</strong> 80% všetkých prenájmov</li>
                <li>• <strong className="text-zinc-900">AI podpora:</strong> Chatboty pre technické otázky</li>
                <li>• <strong className="text-zinc-900">Flexibilita:</strong> Hodinový prenájom (nie len denný)</li>
              </ul>
            </div>
            <div className="bg-orange-500/10 border border-orange-500/30 rounded-xl p-6">
              <h3 className="text-orange-primary font-bold text-lg mb-4">⚠️ Výzvy:</h3>
              <ul className="space-y-2 text-zinc-700 text-sm">
                <li>• <strong className="text-zinc-900">Cenový tlak:</strong> Ďalší pokles -5-8%</li>
                <li>• <strong className="text-zinc-900">Konsolidácia:</strong> Menšie požičovne zanikn ú</li>
                <li>• <strong className="text-zinc-900">Regulácie:</strong> Prísnejšie pravidlá (certifikáty)</li>
                <li>• <strong className="text-zinc-900">Náklady:</strong> Vyššie ceny paliva, servisu</li>
                <li>• <strong className="text-zinc-900">Konkurencia:</strong> Vstup zahraničných firiem</li>
              </ul>
            </div>
          </div>
        </div>
