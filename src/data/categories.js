...
export const categories = [
  {
    ...
    subcategories: [
      ...
      { id: 'zvaracia-technika', name: 'Zváracia technika', slug: 'zvaracia-technika' },
      { id: 'meracia-technika', name: 'Meracia technika', slug: 'meracia-technika' },
  ...
  {
    id: 'volny-cas-a-sport',
    name: 'Voľný čas a šport',
    slug: 'volny-cas-a-sport',
    description: 'Elektrobicykle a vybavenie pre voľný čas a šport',
    subcategories: [
      { id: 'all', name: 'Všetko', slug: 'all' },
    ]
  },
