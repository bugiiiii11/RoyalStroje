...
export default function Kosik() {
  ...
  return (
    <div className="min-h-screen pb-24 relative" style={{ background: '#FAFAFA' }}>
      <Helmet>
      ...
      <div className="container mx-auto px-4 max-w-2xl">
        ...
        <div className="mb-6 text-center pt-16 md:pt-0">
          ...
          <p className="text-zinc-700 text-sm md:text-lg">
        ...
        <div className="bg-gradient-to-b from-zinc-900 to-zinc-950 rounded-2xl border border-white/10 shadow-sm shadow-zinc-900/10 p-4 mb-4">
          ...
          {cartItems.length === 0 ? (
            ...
            <div className="space-y-2 max-h-96 overflow-y-auto">
              {cartItems.map((item) => {
                const itemPrice = item.pricePerDay && !isNaN(item.pricePerDay)
                  ? (customerType === 'po' ? item.pricePerDay : item.pricePerDay * 1.23)
                  : null;
                const priceLabel = customerType === 'po' ? 'bez DPH' : 's DPH';
