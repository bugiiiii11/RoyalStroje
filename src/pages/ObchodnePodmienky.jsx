        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-4 md:px-8 lg:px-12">
          ...
          <div className="text-center mb-6 md:mb-12">
            <h1 className="text-2xl md:text-4xl font-black text-white mb-2 md:mb-4">
              <span className="text-orange-primary">Obchodné</span><br className="md:hidden" /> podmienky
            </h1>
          ...
          <div className="flex justify-center mb-6 md:mb-12">
            <div className="inline-flex bg-zinc-900 border border-white/10 rounded-xl md:rounded-2xl p-1.5 md:p-2 gap-1.5 md:gap-2">
              <button
            ...
            <>
              ...
              <div className="bg-gradient-to-br from-zinc-900 to-zinc-950 border border-orange-primary/30 rounded-xl md:rounded-2xl p-4 md:p-8 mb-6 md:mb-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 text-xs md:text-base">
                  ...
                  <div>
                    <p className="text-white/60 mb-1 text-[10px] md:text-sm">Platné od</p>
                    <p className="text-white font-semibold text-xs md:text-base">01. 02. 2026</p>
                  </div>
                  <div>
                    <p className="text-white/60 mb-1 text-[10px] md:text-sm">Vydavateľ</p>
                    <p className="text-white/80 text-xs md:text-base">ROYAL STROJE s.r.o., Recká cesta 182, 925 26 Boldog – Senec</p>
                  </div>
                  <div>
                    <p className="text-white/60 mb-1 text-[10px] md:text-sm">Web</p>
                    <p className="text-white/80 text-xs md:text-base">www.royalstroje.sk</p>
                  </div>
                  <div className="md:col-span-2">
                    <p className="text-white/60 mb-1 text-[10px] md:text-sm">Určené pre</p>
                    <p className="text-white/80 text-xs md:text-base">Právnické osoby a fyzické osoby – podnikatelia (SZČO)</p>
                  </div>
                </div>
              </div>
            ...
            <>
              ...
              <div className="bg-gradient-to-br from-zinc-900 to-zinc-950 border border-orange-primary/30 rounded-xl md:rounded-2xl p-4 md:p-8 mb-6 md:mb-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 text-xs md:text-base">
                  ...
                  <div className="md:col-span-2">
                    <p className="text-white/60 mb-1 text-[10px] md:text-sm">Určené pre</p>
                    <p className="text-white/80 text-xs md:text-base">Fyzické osoby – nepodnikatelia (spotrebitelia)</p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4 md:space-y-8">
                ...
                <div className="bg-gradient-to-br from-zinc-900 to-zinc-950 border border-white/10 rounded-2xl p-6 md:p-8 hover:border-orange-primary/30 transition-all">
                  ...
                  <div className="space-y-2 md:space-y-3 text-white/80 text-xs md:text-base leading-relaxed">
                    ...
                    <div className="bg-orange-primary/10 border border-orange-primary/30 rounded-lg md:rounded-xl p-3 md:p-4 mt-3 md:mt-4">
