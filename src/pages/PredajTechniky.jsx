  ...
  const categories = [
    {
      ...
      items: ['Pracovné náradie a remeselnícke pomôcky', 'Elektrické a aku ručné náradie', 'Diamantové rezné kotúče a vrtáky rôznych priemerov', 'Príslušenstvo k strojom a náradiu'],
    },
    {
      ...
      items: ['Vibračné dosky a nohy', 'Elektrocentrály', 'Rezná technika', 'Rôzne príslušenstvo'],
    },
    {
      id: 'prislusenstvo',
      icon: ShoppingCart,
